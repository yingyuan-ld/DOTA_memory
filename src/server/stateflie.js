let state_list = [
	...
	{id:15,name:"变身",message:"攻击加100,攻速加80"},
	{id:16,name:"嚎叫",message:"攻击加60"},
	{id:17,name:"化学狂暴",message:"攻速加100,生命恢复回复加150"},
	{id:18,name:"战吼",message:"增加30点护甲"},
	{id:19,name:"神之力量",message:"三回合内攻击增加200"},
	...
	{id:44,name:"灵魂猎手",message:"该单位承受伤害加深50%"},
	{id:45,name:"编织",message:"该单位护甲+25"},
	{id:46,name:"薄葬",message:"该单位不会死亡"},
	{id:47,name:"激光",message:"该单位物理攻击100%miss"},
	{id:48,name:"超负荷",message:"每放1次技能就可以增加自己100点攻击,不可叠加,维持一次攻击"},
	{id:49,name:"法力流失",message:"该单位攻击所需mp翻倍"},
	{id:50,name:"虚妄之诺",message:"生命恢复增加1倍伤害减为一半"},
	{id:51,name:"命运赦令",message:"该单位不能攻击且所受物理伤害加倍"},
	{id:52,name:"恶魔赦令",message:"该单位每回合对敌方造成80点伤害"},
	{id:53,name:"致命链接",message:"额外造成手牌数0.1倍伤害 "},
	{id:54,name:"虚弱",message:"该单位攻击力-50"},
	{id:55,name:"噩梦",message:"该单位沉睡中,不能出牌,攻击和使用装备"},
	{id:56,name:"诅咒",message:"该单位能量值-1"},
	{id:57,name:"旋风飞斧",message:"该单位攻击有30%的概率miss"},
	{id:58,name:"血之狂暴",message:"该单位无法使用技能,伤害增加50%,受伤增加50%"},
	...
	{id:64,name:"编织",message:"该单位护甲-25"},
	{id:65,name:"高射火炮",message:"该单位攻击+70"},
	{id:66,name:"嗜血术",message:"该单位攻击+30"},
	{id:67,name:"灼热之箭",message:"攻击消耗20魔法值,附加50攻击"},
	{id:68,name:"极寒之拥",message:"该单位护甲+100,且不可攻击,出牌和实用装备"},
	{id:69,name:"毒性攻击",message:"增加(对方已损失生命值百分比*200)的攻击"},
	{id:70,name:"狂战士之怒",message:"该单位血量<50%时,攻击次数+1且不消耗能量格"},
	{id:71,name:"扫射",message:"增加100%攻击速度"},
	{id:72,name:"沸血之矛",message:"该单位攻击+100"},
	{id:73,name:"酸性喷雾",message:"该单位护甲-10"},
	{id:74,name:"严寒灼烧",message:"增加敌方当前生命值10%的攻击力"},
	{id:75,name:"火力聚焦",message:"三回合内减少自身50%攻击,增加300攻速"},
	{id:76,name:"智慧之刃",message:"增加同等魔法恢复速度的攻击"},
	{id:77,name:"霜冻护甲",message:"该单位护甲+20"},
	{id:78,name:"秘法天球",message:"增加魔法值25%的攻击力"},
	{id:79,name:"暗影之舞",message:"增加5%生命恢复并使敌方在2回合内无法攻击自己"},
	{id:80,name:"激怒",message:"伤害减少90%"},
	...
	{id:90,name:"竭心光环",message:"每回合减少敌方3%生命值"},
	{id:91,name:"施虐之心",message:"每对敌方造成100点伤害回复50点魔法和50点生命"},
	{id:92,name:"不可侵犯",message:"减少对方50%攻击速度"},
	...
	{id:98,name:"月刃",message:"对方每张手牌,增加自己10%的攻击"},
	...
	{id:121,name:"恐怖波动",message:"减少10点护甲"},
	{id:122,name:"腐肉堆积",message:"敌方每少一张手牌自己加40点血，并且加40点血量上限"},
	{id:123,name:"醉拳",message:"受到普通攻击时有40%的概率mis"},
	{id:124,name:"重击",message:"攻击时有30%的概率击晕敌方一回合并附加70点伤害"},
	{id:125,name:"法力损毁",message:"普通攻击成功后可以削减敌方50能量值"},
	{id:126,name:"地之突袭",message:"攻击力加30"},
	{id:127,name:"带刺外壳",message:"受到伤害时,晕眩敌方半回合"},
	{id:128,name:"命令光环",message:"增加30%的攻击力"},
	{id:129,name:"强击光环",message:"增加25%的攻击力"},
	{id:130,name:"射手天赋",message:"增加100点攻击力,100攻速"},
	...
	{id:135,name:"热血战魂",message:"每次普通攻击增加30攻速"},
	{id:136,name:"毒刺",message:"攻击时对敌方额外造成20点伤害"},
	{id:137,name:"幽冥剧毒",message:"增加(对方已损失生命值百分比*200)的攻击"},
	...
	{id:142,name:"魔法护盾",message:"受到伤害时1蓝可以抵挡5伤害"},
	{id:143,name:"能量转换",message:"每次攻击永久减少敌方1点攻击力,并增加该单位2点攻击"},
	{id:144,name:"怒意狂击",message:"每次普通攻击成功后攻击力会增加20"},
	{id:145,name:"回到过去",message:"有30%的概率免疫伤害"},
	{id:146,name:"时间锁定",message:"普通攻击时有25%的概率使敌方晕眩一回合"},
	{id:147,name:"嗜血渴望",message:"敌方血量低于50%时，增加加70点攻击"},
	{id:148,name:"支配死灵",message:"敌方每减少一张牌,可以增加30点攻击"},
	{id:149,name:"荒芜",message:"增加50点攻击"},
	{id:150,name:"折射",message:"反弹自己受到一切伤害的25%"},
	{id:151,name:"麻痹撕咬",message:"普通攻击成功后可以使敌方1回合内有50%的概率攻击mis"},
	{id:152,name:"月之祝福",message:"攻击力加60"},
	{id:153,name:"辉煌光环",message:"增加50点魔法值恢复"},
	{id:154,name:"超负荷",message:"每放1次技能就可以增加自己40点攻击,不可叠加,维持一次攻击"},
	{id:155,name:"精气光环",message:"释放技能时有50%的概率加100点魔法值"},
	{id:156,name:"连击",message:"每回合增加一次攻击次数"},
	{id:157,name:"多重施法",message:"释放技能时有50%的概率3倍暴击"},
	{id:158,name:"嗜血术",message:"3回合内增加自己30%攻击速度"},
	{id:159,name:"活血术",message:"生命值回复速度*5"},
	{id:160,name:"变身",message:"永久增加20点攻击力"},
	{id:161,name:"静默诅咒",message:"生命与魔法值恢复速度减少50"},
	{id:162,name:"暗言术",message:"每回合造成60点伤害"},
	{id:163,name:"液态火",message:"普通攻击成功后,对其每回合造成60点伤害持续3回合"},
	{id:164,name:"液态火",message:"每回合造成60点伤害"},
	{id:165,name:"竭心光环",message:"每回合减少3%生命值"},
	{id:166,name:"上古封印",message:"承受1.5倍魔法伤害，并沉默"},
	{id:167,name:"巫毒回复术",message:"每回合消耗50魔法,恢复100生命"},
	{id:168,name:"不可侵犯",message:"减少50%攻击速度"},
	{id:169,name:"幽冥守卫",message:"对敌方造成敌方消耗魔法值的伤害"},
]
