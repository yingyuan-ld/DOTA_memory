let state_list = [
	...
	{id:82,name:"撒旦",message:"将受到伤害转化为生命值"},
	...
	{id:155,name:"精气光环",message:"释放技能时有50%的概率加1点能量值"},
	{id:156,name:"连击",message:"每次攻击降低敌方10点护甲"},
	{id:157,name:"多重施法",message:"释放技能时有50%的概率2倍暴击"},
	{id:158,name:"嗜血术",message:"增加自己30点攻击力"},
	{id:159,name:"竭心光环",message:"每回合减少敌方0.1%生命值"},
	{id:160,name:"施虐之心",message:"每对敌方造成200点伤害回复1点能量格和100点生命"},
	{id:161,name:"不可侵犯",message:"使对方普通攻击时消耗双倍能量格"},
	{id:162,name:"魔王降临",message:"减少敌方20点护甲"},
	{id:163,name:"屠戮",message:"敌方每减少一张手牌自己回复30点生命"},
	{id:164,name:"静电场",message:"每次释放任何技能都会对敌方造成40点伤害"},
	{id:165,name:"霜之哀伤",message:"攻击成功后会弃置敌方一张手牌"},
	{id:166,name:"巨力重击",message:"攻击时有30%的概率晕眩敌方一回合并额外造成40点伤害"},
	{id:167,name:"月刃",message:"攻击力加敌方手牌数乘10的数值"},
	{id:168,name:"巨力挥舞",message:"普通攻击时增加加敌方手牌数乘10的攻击力"}
]
