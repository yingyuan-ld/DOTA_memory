...
function doskill(mystate, cardid) {
    //使用技能
    ...
    _createClass(HeroPlaceMy, [{
        ...
        value: function cardlist() {
            ...
            return this.props.mystate.cardid.map(function (card, i) {
                return _react2.default.createElement(_Card2.default, _extends({ card: card }, _this2.props, { key: i }));
            });
        }
    }, {
        key: 'render',
...
var Card = function (_React$Component) {
    ...
    _createClass(Card, [{
        ...
        value: function usecard(id) {
            var newstate = (0, _action.doskill)(id);
        ...
        value: function render() {
            ...
            if (this.props.show) {
                return _react2.default.createElement(
                    'div',
                    { className: 'card_box', onClick: this.usecard(card.id) },
...
small_skill[0] = { id: 1000, name: "雷霆之击", state: 1, message: "对敌方造成200点伤害" };
small_skill[1] = { id: 1001, name: "马蹄践踏", state: 0, message: "使敌方造成30点伤害并晕眩1回合(可闪避)" };
small_skill[2] = { id: 1002, name: "双刃剑", state: 1, message: "使自己和敌方同时受到150点伤害" };
small_skill[3] = { id: 1003, name: "反击", state: 2, message: "被动牌:在自己受到伤害时对敌方造成自身承受伤害的20%" };
small_skill[4] = { id: 1004, name: "巨浪", state: 0, message: "减少敌方十点护甲并对对方造成100点伤害(可闪避)" };
small_skill[5] = { id: 1005, name: "海妖外壳", state: 2, message: "被动牌:受到普通攻击时可以减少50点伤害" };
small_skill[6] = { id: 1006, name: "锚击", state: 1, message: "使自己在本回合内的攻击力增加敌方手牌数乘以10的数目" };
small_skill[7] = { id: 1007, name: "洪流", state: 0, message: "对敌方造成50点伤害并晕眩半回合(可闪避)" };
small_skill[8] = { id: 1008, name: "潮汐使者", state: 2, message: "被动牌:使自己增加30点攻击力" };
small_skill[9] = { id: 1009, name: "死亡旋风", state: 0, message: "对敌方造成110点伤害(可闪避)" };
small_skill[10] = { id: 1010, name: "伐木链锯", state: 0, message: "对敌方造成自己攻击力加50的伤害(可闪避)" };
small_skill[11] = { id: 1011, name: "活性护甲", state: 2, message: "被动牌:每受到一次攻击增加10点护甲" };
small_skill[12] = { id: 1012, name: "死亡缠绕", state: 1, message: "使自己回复70点生命并对敌方造成70点伤害" };
small_skill[13] = { id: 1013, name: "无光之盾", state: 2, message: "三回合内抵挡自己150点伤害并在破裂时对敌方造成70点伤害" };
small_skill[14] = { id: 1014, name: "霜之哀伤", state: 2, message: "被动牌:成功攻击对手后可以去除对手一张手牌" };
small_skill[15] = { id: 1015, name: "烈火精灵", state: 1, message: "对敌方造成90点伤害并且减少敌方一点能量值" };
small_skill[16] = { id: 1016, name: "烈日炎烤", state: 0, message: "对自己造成50点伤害并造成敌方现有生命值5%的伤害(可闪避)" };
small_skill[17] = { id: 1017, name: "战士怒吼", state: 0, message: "增加自己40点护甲,使敌方下一回合只可以攻击自己(可闪避)" };
small_skill[18] = { id: 1018, name: "反击螺旋", state: 2, message: "被动牌:敌方普通攻击自己时会受到40点伤害" };
small_skill[19] = { id: 1019, name: "寒冰碎片", state: 0, message: "对敌方造成80点伤害(可闪避)" };
small_skill[20] = { id: 1020, name: "雪球", state: 0, message: "对敌方造成80点伤害并晕眩半回合(可闪避)" };
small_skill[21] = { id: 1021, name: "沟壑", state: 0, message: "对敌方造成90点伤害并晕眩一回合(可闪避)" };
small_skill[22] = { id: 1022, name: "强化图腾", state: 2, message: "三回合内使自己攻击力变为现在攻击力的2倍，攻击后恢复正常" };
small_skill[23] = { id: 1023, name: "余震", state: 2, message: "被动牌:自己使用任何技能都会至少使敌方眩晕半回合" };
small_skill[24] = { id: 1024, name: "混乱之箭", state: 1, message: "随机对敌方造成1-200的伤害，并晕眩1-2回合" };
small_skill[25] = { id: 1025, name: "实相裂隙", state: 1, message: "可以攻击对方一次，不和普通攻击冲突" };
small_skill[26] = { id: 1026, name: "致命一击", state: 2, message: "被动牌:攻击力会上下变动" };
small_skill[27] = { id: 1027, name: "幽光之魂", state: 0, message: "对敌方造成130点伤害(可闪避)" };
small_skill[28] = { id: 1028, name: "压倒性优势", state: 0, message: "对敌方造成敌方手牌乘以30的伤害(可闪避)" };
small_skill[29] = { id: 1029, name: "勇气之霎", state: 2, message: "被动牌:受到普通攻击时有40%的概率增加自己100点血" };
small_skill[30] = { id: 1030, name: "强攻", state: 1, message: "使自己回复100点生命值并攻击对方一次" };
small_skill[31] = { id: 1031, name: "冥火暴击", state: 0, message: "对敌方造成70点伤害并晕眩1回合(可闪避)" };
small_skill[32] = { id: 1032, name: "吸血光环", state: 2, message: "被动牌:普通攻击时将对方受到伤害的30%转化成自己的生命值" };
small_skill[33] = { id: 1033, name: "致死打击", state: 2, message: "被动牌:攻击时有60%的概率1.5倍攻击" };
small_skill[34] = { id: 1034, name: "嚎叫", state: 1, message: "本回合攻击加60" };
small_skill[35] = { id: 1035, name: "野性驱使", state: 2, message: "被动牌:攻击加30" };
small_skill[36] = { id: 1036, name: "酸性喷雾", state: 0, message: "三回合内降低敌方10点防御并造成50点伤害(可闪避)" };
small_skill[37] = { id: 1037, name: "不稳定物", state: 0, message: "50%使对方晕眩两回合50%使自己晕眩一回合(可闪避)" };
small_skill[38] = { id: 1038, name: "地精贪婪", state: 2, message: "被动牌:每回合得到金钱数+10" };
small_skill[39] = { id: 1039, name: "暗影冲刺", state: 0, message: "对敌方造成60点伤害并眩晕半回合(可闪避)" };
small_skill[40] = { id: 1040, name: "巨力重击", state: 2, message: "被动牌:攻击时有30%的概率使敌方晕眩一回合并造成40点伤害" };
small_skill[41] = { id: 1041, name: "风暴之锤", state: 0, message: "对敌方造成100点伤害并晕眩一回合(可闪避)" };
small_skill[42] = { id: 1042, name: "巨力挥舞", state: 2, message: "被动牌:普通攻击时增加加敌方手牌数乘10的攻击力" };
small_skill[43] = { id: 1043, name: "战吼", state: 2, message: "三回合内增加自身30点护甲" };
small_skill[44] = { id: 1044, name: "火焰气息", state: 0, message: "对敌方造成120点伤害(可闪避)" };
small_skill[45] = { id: 1045, name: "神龙摆尾", state: 1, message: "对敌方造成50点伤害并晕眩一回合" };
small_skill[46] = { id: 1046, name: "龙族血统", state: 2, message: "被动牌:每回合回复40点生命值" };
small_skill[47] = { id: 1047, name: "震荡波", state: 0, message: "对敌方造成130点伤害" };
small_skill[48] = { id: 1048, name: "授予力量", state: 2, message: "本回合内攻击加80" };
small_skill[49] = { id: 1049, name: "獠牙冲刺", state: 0, message: "对敌方造成60点伤害(可闪避)" };
small_skill[50] = { id: 1050, name: "吞噬", state: 2, message: "如果手牌还没有达到上限，可以再摸两张牌" };
small_skill[51] = { id: 1051, name: "焦土", state: 1, message: "敌方掉70血，自己回复80血" };
small_skill[52] = { id: 1052, name: "回音重踏", state: 0, message: "使对方晕眩两回合，对方受到任何伤害都会解除眩晕状态(可闪避)" };
small_skill[53] = { id: 1053, name: "自然秩序", state: 2, message: "被动牌:使对方护甲归0" };
small_skill[54] = { id: 1054, name: "洗礼", state: 0, message: "回复自己200点生命值(可闪避)" };
small_skill[55] = { id: 1055, name: "驱逐", state: 2, message: "使自己魔免两回合，可以被散失" };
small_skill[56] = { id: 1056, name: "掘地穿刺", state: 0, message: "对敌方造成65点伤害并晕眩一回合(可闪避)" };
